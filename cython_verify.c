...
#define __PYX_HAVE__cython_verify
#define __PYX_HAVE_API__cython_verify
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
/* Module declarations from 'cython_verify' */
...
static __Pyx_memviewslice __pyx_f_13cython_verify_verify_image(__Pyx_memviewslice, __Pyx_memviewslice, float, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "cython_verify"
extern int __pyx_module_is_main_cython_verify;
int __pyx_module_is_main_cython_verify = 0;

/* Implementation of 'cython_verify' */
...
static const char __pyx_k_Percentage_of_failure[] = "Percentage of failure: {}%";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_MemoryView_of_r_object[] = "<MemoryView of %r object>";
static const char __pyx_k_MemoryView_of_r_at_0x_x[] = "<MemoryView of %r at 0x%x>";
static const char __pyx_k_Percent_tolerance_given[] = "Percent tolerance given: {}%";
static const char __pyx_k_contiguous_and_indirect[] = "<contiguous and indirect>";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_Image_passed_w_tolerance[] = "Image passed w/ tolerance: {}%";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_Percentage_tolerance_given[] = "Percentage tolerance given: {}%";
...
static const char __pyx_k_Image_is_exact_match_Zero_percen[] = "Image is exact match. Zero percent tolerance.";
...
static PyObject *__pyx_kp_s_Image_is_exact_match_Zero_percen;
static PyObject *__pyx_kp_s_Image_passed_w_tolerance;
...
static PyObject *__pyx_kp_s_Percent_tolerance_given;
static PyObject *__pyx_kp_s_Percentage_of_failure;
static PyObject *__pyx_kp_s_Percentage_tolerance_given;
...
static PyObject *__pyx_pf_13cython_verify_verify_image(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_ref, __Pyx_memviewslice __pyx_v_test, float __pyx_v_tolerance, int __pyx_v_cnt); /* proto */
...
static PyObject *__pyx_pw_13cython_verify_1verify_image(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_13cython_verify_verify_image(__Pyx_memviewslice __pyx_v_ref, __Pyx_memviewslice __pyx_v_test, float __pyx_v_tolerance, int __pyx_v_cnt, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_h;
  int __pyx_v_w;
  int __pyx_v_exact_match;
  CYTHON_UNUSED int __pyx_v_bad_pix_cnt;
  int __pyx_v_pix_sum;
  float __pyx_v_err_sum;
  float __pyx_v_amt_dif;
  float __pyx_v_avg_err;
  PyObject *__pyx_v_cmp_img_data = NULL;
  ...
  __Pyx_RefNannySetupContext("verify_image", 0);

  /* "cython_verify.pyx":17
 ...
 */
  ...
  __pyx_t_2 = 0;
  __pyx_t_3 = 0;
  __pyx_v_exact_match = __pyx_t_1;
  __pyx_v_bad_pix_cnt = __pyx_t_2;
  __pyx_v_pix_sum = __pyx_t_3;

  /* "cython_verify.pyx":18
 *     cdef float err_sum, amt_dif, avg_err
 *     exact_match, bad_pix_cnt, pix_sum = 1, 0, 0
 *     err_sum, amt_dif, avg_err = 0.0, 0.0, 0.0             # <<<<<<<<<<<<<<
 *     h = ref.shape[0]
 ...
 */
  ...
  __pyx_t_5 = 0.0;
  __pyx_t_6 = 0.0;
  __pyx_v_err_sum = __pyx_t_4;
  __pyx_v_amt_dif = __pyx_t_5;
  __pyx_v_avg_err = __pyx_t_6;

  /* "cython_verify.pyx":19
 *     exact_match, bad_pix_cnt, pix_sum = 1, 0, 0
 *     err_sum, amt_dif, avg_err = 0.0, 0.0, 0.0
 *     h = ref.shape[0]             # <<<<<<<<<<<<<<
 *     w = ref.shape[1]
 * 
 */
  __pyx_v_h = (__pyx_v_ref.shape[0]);

  /* "cython_verify.pyx":20
 *     err_sum, amt_dif, avg_err = 0.0, 0.0, 0.0
 *     h = ref.shape[0]
 *     w = ref.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_w = (__pyx_v_ref.shape[1]);

  /* "cython_verify.pyx":22
 *     w = ref.shape[1]
 * 
 *     cmp_img_data = np.zeros((768, 1024, 3), dtype="uint8")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_zeros); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  if (PyDict_SetItem(__pyx_t_7, __pyx_n_s_dtype, __pyx_n_s_uint8) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_tuple__2, __pyx_t_7); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v_cmp_img_data = __pyx_t_9;
  __pyx_t_9 = 0;

  /* "cython_verify.pyx":24
 *     cmp_img_data = np.zeros((768, 1024, 3), dtype="uint8")
 * 
 *     for y in range(h):             # <<<<<<<<<<<<<<
 *         for x in range(w):
 ...
 *                 exact_match = 0
 */
      __pyx_v_pix_sum = (__pyx_v_pix_sum + 3);

      /* "cython_verify.pyx":27
 *         for x in range(w):
 *             pix_sum += 3
 *             if ref[y, x, 0] != test[y, x, 0] and ref[y, x, 0] != test[y, x, 0] and ref[y, x, 0] != test[y, x, 0]:             # <<<<<<<<<<<<<<
 *                 exact_match = 0
 ...
 */
      ...
      __pyx_t_17 = -1;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_v_ref.shape[0];
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_17 = 0;
      } else if (unlikely(__pyx_t_14 >= __pyx_v_ref.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_ref.shape[1];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_ref.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_ref.shape[2];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_ref.shape[2])) __pyx_t_17 = 2;
      ...
      __pyx_t_17 = -1;
      if (__pyx_t_18 < 0) {
        __pyx_t_18 += __pyx_v_test.shape[0];
        if (unlikely(__pyx_t_18 < 0)) __pyx_t_17 = 0;
      } else if (unlikely(__pyx_t_18 >= __pyx_v_test.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_v_test.shape[1];
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_19 >= __pyx_v_test.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_20 < 0) {
        __pyx_t_20 += __pyx_v_test.shape[2];
        if (unlikely(__pyx_t_20 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_20 >= __pyx_v_test.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      __pyx_t_21 = (((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ref.data + __pyx_t_14 * __pyx_v_ref.strides[0]) ) + __pyx_t_15 * __pyx_v_ref.strides[1]) ) + __pyx_t_16 * __pyx_v_ref.strides[2]) ))) != (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_test.data + __pyx_t_18 * __pyx_v_test.strides[0]) ) + __pyx_t_19 * __pyx_v_test.strides[1]) ) + __pyx_t_20 * __pyx_v_test.strides[2]) )))) != 0);
      if (__pyx_t_21) {
      } else {
      ...
      __pyx_t_17 = -1;
      if (__pyx_t_22 < 0) {
        __pyx_t_22 += __pyx_v_ref.shape[0];
        if (unlikely(__pyx_t_22 < 0)) __pyx_t_17 = 0;
      } else if (unlikely(__pyx_t_22 >= __pyx_v_ref.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_v_ref.shape[1];
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_23 >= __pyx_v_ref.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_v_ref.shape[2];
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_24 >= __pyx_v_ref.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      ...
      __pyx_t_17 = -1;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_v_test.shape[0];
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_17 = 0;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_test.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_26 < 0) {
        __pyx_t_26 += __pyx_v_test.shape[1];
        if (unlikely(__pyx_t_26 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_26 >= __pyx_v_test.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_v_test.shape[2];
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_27 >= __pyx_v_test.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      __pyx_t_21 = (((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ref.data + __pyx_t_22 * __pyx_v_ref.strides[0]) ) + __pyx_t_23 * __pyx_v_ref.strides[1]) ) + __pyx_t_24 * __pyx_v_ref.strides[2]) ))) != (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_test.data + __pyx_t_25 * __pyx_v_test.strides[0]) ) + __pyx_t_26 * __pyx_v_test.strides[1]) ) + __pyx_t_27 * __pyx_v_test.strides[2]) )))) != 0);
      if (__pyx_t_21) {
      } else {
        __pyx_t_13 = __pyx_t_21;
        goto __pyx_L8_bool_binop_done;
      ...
      __pyx_t_17 = -1;
      if (__pyx_t_28 < 0) {
        __pyx_t_28 += __pyx_v_ref.shape[0];
        if (unlikely(__pyx_t_28 < 0)) __pyx_t_17 = 0;
      } else if (unlikely(__pyx_t_28 >= __pyx_v_ref.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_29 < 0) {
        __pyx_t_29 += __pyx_v_ref.shape[1];
        if (unlikely(__pyx_t_29 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_29 >= __pyx_v_ref.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_30 < 0) {
        __pyx_t_30 += __pyx_v_ref.shape[2];
        if (unlikely(__pyx_t_30 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_30 >= __pyx_v_ref.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      ...
      __pyx_t_17 = -1;
      if (__pyx_t_31 < 0) {
        __pyx_t_31 += __pyx_v_test.shape[0];
        if (unlikely(__pyx_t_31 < 0)) __pyx_t_17 = 0;
      } else if (unlikely(__pyx_t_31 >= __pyx_v_test.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_32 < 0) {
        __pyx_t_32 += __pyx_v_test.shape[1];
        if (unlikely(__pyx_t_32 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_32 >= __pyx_v_test.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_33 < 0) {
        __pyx_t_33 += __pyx_v_test.shape[2];
        if (unlikely(__pyx_t_33 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_33 >= __pyx_v_test.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      __pyx_t_21 = (((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ref.data + __pyx_t_28 * __pyx_v_ref.strides[0]) ) + __pyx_t_29 * __pyx_v_ref.strides[1]) ) + __pyx_t_30 * __pyx_v_ref.strides[2]) ))) != (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_test.data + __pyx_t_31 * __pyx_v_test.strides[0]) ) + __pyx_t_32 * __pyx_v_test.strides[1]) ) + __pyx_t_33 * __pyx_v_test.strides[2]) )))) != 0);
      __pyx_t_13 = __pyx_t_21;
      __pyx_L8_bool_binop_done:;
      if (__pyx_t_13) {

        /* "cython_verify.pyx":28
 *             pix_sum += 3
 *             if ref[y, x, 0] != test[y, x, 0] and ref[y, x, 0] != test[y, x, 0] and ref[y, x, 0] != test[y, x, 0]:
 *                 exact_match = 0             # <<<<<<<<<<<<<<
 *                 amt_dif = sqrt((ref[y, x, 0] - test[y, x, 0]) ** 2) \
 ...
 */
        __pyx_v_exact_match = 0;

        /* "cython_verify.pyx":29
 *             if ref[y, x, 0] != test[y, x, 0] and ref[y, x, 0] != test[y, x, 0] and ref[y, x, 0] != test[y, x, 0]:
 *                 exact_match = 0
 *                 amt_dif = sqrt((ref[y, x, 0] - test[y, x, 0]) ** 2) \             # <<<<<<<<<<<<<<
 *                 + sqrt((ref[y, x, 1] - test[y, x, 1]) ** 2) \
 ...
 */
        ...
        __pyx_t_17 = -1;
        if (__pyx_t_34 < 0) {
          __pyx_t_34 += __pyx_v_ref.shape[0];
          if (unlikely(__pyx_t_34 < 0)) __pyx_t_17 = 0;
        } else if (unlikely(__pyx_t_34 >= __pyx_v_ref.shape[0])) __pyx_t_17 = 0;
        if (__pyx_t_35 < 0) {
          __pyx_t_35 += __pyx_v_ref.shape[1];
          if (unlikely(__pyx_t_35 < 0)) __pyx_t_17 = 1;
        } else if (unlikely(__pyx_t_35 >= __pyx_v_ref.shape[1])) __pyx_t_17 = 1;
        if (__pyx_t_36 < 0) {
          __pyx_t_36 += __pyx_v_ref.shape[2];
          if (unlikely(__pyx_t_36 < 0)) __pyx_t_17 = 2;
        } else if (unlikely(__pyx_t_36 >= __pyx_v_ref.shape[2])) __pyx_t_17 = 2;
        if (unlikely(__pyx_t_17 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_17);
        ...
        __pyx_t_17 = -1;
        if (__pyx_t_37 < 0) {
          __pyx_t_37 += __pyx_v_test.shape[0];
          if (unlikely(__pyx_t_37 < 0)) __pyx_t_17 = 0;
        } else if (unlikely(__pyx_t_37 >= __pyx_v_test.shape[0])) __pyx_t_17 = 0;
        if (__pyx_t_38 < 0) {
          __pyx_t_38 += __pyx_v_test.shape[1];
          if (unlikely(__pyx_t_38 < 0)) __pyx_t_17 = 1;
        } else if (unlikely(__pyx_t_38 >= __pyx_v_test.shape[1])) __pyx_t_17 = 1;
        if (__pyx_t_39 < 0) {
          __pyx_t_39 += __pyx_v_test.shape[2];
          if (unlikely(__pyx_t_39 < 0)) __pyx_t_17 = 2;
        } else if (unlikely(__pyx_t_39 >= __pyx_v_test.shape[2])) __pyx_t_17 = 2;
        if (unlikely(__pyx_t_17 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_17);
          __PYX_ERR(0, 29, __pyx_L1_error)
        }

        /* "cython_verify.pyx":30
 *                 exact_match = 0
 *                 amt_dif = sqrt((ref[y, x, 0] - test[y, x, 0]) ** 2) \
 *                 + sqrt((ref[y, x, 1] - test[y, x, 1]) ** 2) \             # <<<<<<<<<<<<<<
 *                 + sqrt((ref[y, x, 2] - test[y, x, 2]) ** 2)
 ...
 */
        ...
        __pyx_t_17 = -1;
        if (__pyx_t_40 < 0) {
          __pyx_t_40 += __pyx_v_ref.shape[0];
          if (unlikely(__pyx_t_40 < 0)) __pyx_t_17 = 0;
        } else if (unlikely(__pyx_t_40 >= __pyx_v_ref.shape[0])) __pyx_t_17 = 0;
        if (__pyx_t_41 < 0) {
          __pyx_t_41 += __pyx_v_ref.shape[1];
          if (unlikely(__pyx_t_41 < 0)) __pyx_t_17 = 1;
        } else if (unlikely(__pyx_t_41 >= __pyx_v_ref.shape[1])) __pyx_t_17 = 1;
        if (__pyx_t_42 < 0) {
          __pyx_t_42 += __pyx_v_ref.shape[2];
          if (unlikely(__pyx_t_42 < 0)) __pyx_t_17 = 2;
        } else if (unlikely(__pyx_t_42 >= __pyx_v_ref.shape[2])) __pyx_t_17 = 2;
        if (unlikely(__pyx_t_17 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_17);
        ...
        __pyx_t_17 = -1;
        if (__pyx_t_43 < 0) {
          __pyx_t_43 += __pyx_v_test.shape[0];
          if (unlikely(__pyx_t_43 < 0)) __pyx_t_17 = 0;
        } else if (unlikely(__pyx_t_43 >= __pyx_v_test.shape[0])) __pyx_t_17 = 0;
        if (__pyx_t_44 < 0) {
          __pyx_t_44 += __pyx_v_test.shape[1];
          if (unlikely(__pyx_t_44 < 0)) __pyx_t_17 = 1;
        } else if (unlikely(__pyx_t_44 >= __pyx_v_test.shape[1])) __pyx_t_17 = 1;
        if (__pyx_t_45 < 0) {
          __pyx_t_45 += __pyx_v_test.shape[2];
          if (unlikely(__pyx_t_45 < 0)) __pyx_t_17 = 2;
        } else if (unlikely(__pyx_t_45 >= __pyx_v_test.shape[2])) __pyx_t_17 = 2;
        if (unlikely(__pyx_t_17 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_17);
          __PYX_ERR(0, 30, __pyx_L1_error)
        }

        /* "cython_verify.pyx":31
 *                 amt_dif = sqrt((ref[y, x, 0] - test[y, x, 0]) ** 2) \
 *                 + sqrt((ref[y, x, 1] - test[y, x, 1]) ** 2) \
 *                 + sqrt((ref[y, x, 2] - test[y, x, 2]) ** 2)             # <<<<<<<<<<<<<<
 *                 err_sum += amt_dif
 ...
 */
        ...
        __pyx_t_17 = -1;
        if (__pyx_t_46 < 0) {
          __pyx_t_46 += __pyx_v_ref.shape[0];
          if (unlikely(__pyx_t_46 < 0)) __pyx_t_17 = 0;
        } else if (unlikely(__pyx_t_46 >= __pyx_v_ref.shape[0])) __pyx_t_17 = 0;
        if (__pyx_t_47 < 0) {
          __pyx_t_47 += __pyx_v_ref.shape[1];
          if (unlikely(__pyx_t_47 < 0)) __pyx_t_17 = 1;
        } else if (unlikely(__pyx_t_47 >= __pyx_v_ref.shape[1])) __pyx_t_17 = 1;
        if (__pyx_t_48 < 0) {
          __pyx_t_48 += __pyx_v_ref.shape[2];
          if (unlikely(__pyx_t_48 < 0)) __pyx_t_17 = 2;
        } else if (unlikely(__pyx_t_48 >= __pyx_v_ref.shape[2])) __pyx_t_17 = 2;
        if (unlikely(__pyx_t_17 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_17);
        ...
        __pyx_t_17 = -1;
        if (__pyx_t_49 < 0) {
          __pyx_t_49 += __pyx_v_test.shape[0];
          if (unlikely(__pyx_t_49 < 0)) __pyx_t_17 = 0;
        } else if (unlikely(__pyx_t_49 >= __pyx_v_test.shape[0])) __pyx_t_17 = 0;
        if (__pyx_t_50 < 0) {
          __pyx_t_50 += __pyx_v_test.shape[1];
          if (unlikely(__pyx_t_50 < 0)) __pyx_t_17 = 1;
        } else if (unlikely(__pyx_t_50 >= __pyx_v_test.shape[1])) __pyx_t_17 = 1;
        if (__pyx_t_51 < 0) {
          __pyx_t_51 += __pyx_v_test.shape[2];
          if (unlikely(__pyx_t_51 < 0)) __pyx_t_17 = 2;
        } else if (unlikely(__pyx_t_51 >= __pyx_v_test.shape[2])) __pyx_t_17 = 2;
        if (unlikely(__pyx_t_17 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_17);
          __PYX_ERR(0, 31, __pyx_L1_error)
        }
        __pyx_v_amt_dif = ((sqrt(__Pyx_pow_long(((long)((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ref.data + __pyx_t_34 * __pyx_v_ref.strides[0]) ) + __pyx_t_35 * __pyx_v_ref.strides[1]) ) + __pyx_t_36 * __pyx_v_ref.strides[2]) ))) - (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_test.data + __pyx_t_37 * __pyx_v_test.strides[0]) ) + __pyx_t_38 * __pyx_v_test.strides[1]) ) + __pyx_t_39 * __pyx_v_test.strides[2]) ))))), 2)) + sqrt(__Pyx_pow_long(((long)((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ref.data + __pyx_t_40 * __pyx_v_ref.strides[0]) ) + __pyx_t_41 * __pyx_v_ref.strides[1]) ) + __pyx_t_42 * __pyx_v_ref.strides[2]) ))) - (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_test.data + __pyx_t_43 * __pyx_v_test.strides[0]) ) + __pyx_t_44 * __pyx_v_test.strides[1]) ) + __pyx_t_45 * __pyx_v_test.strides[2]) ))))), 2))) + sqrt(__Pyx_pow_long(((long)((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ref.data + __pyx_t_46 * __pyx_v_ref.strides[0]) ) + __pyx_t_47 * __pyx_v_ref.strides[1]) ) + __pyx_t_48 * __pyx_v_ref.strides[2]) ))) - (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_test.data + __pyx_t_49 * __pyx_v_test.strides[0]) ) + __pyx_t_50 * __pyx_v_test.strides[1]) ) + __pyx_t_51 * __pyx_v_test.strides[2]) ))))), 2)));

        /* "cython_verify.pyx":32
 *                 + sqrt((ref[y, x, 1] - test[y, x, 1]) ** 2) \
 *                 + sqrt((ref[y, x, 2] - test[y, x, 2]) ** 2)
 *                 err_sum += amt_dif             # <<<<<<<<<<<<<<
 * 
 *                 if (amt_dif / 1.5) > 255:
 */
        __pyx_v_err_sum = (__pyx_v_err_sum + __pyx_v_amt_dif);

        /* "cython_verify.pyx":34
 *                 err_sum += amt_dif
 * 
 *                 if (amt_dif / 1.5) > 255:             # <<<<<<<<<<<<<<
 ...
 *                 else:
 */
        __pyx_t_13 = (((__pyx_v_amt_dif / 1.5) > 255.0) != 0);
        if (__pyx_t_13) {

          /* "cython_verify.pyx":35
 * 
 *                 if (amt_dif / 1.5) > 255:
 *                     cmp_img_data[y][x] = np.array([0, 0, 1])             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
          ...
          __Pyx_GOTREF(__pyx_t_7);
          __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_array); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 35, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_8);
          __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
          ...
          if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_8))) {
            __pyx_t_52 = PyMethod_GET_SELF(__pyx_t_8);
          ...
          if (!__pyx_t_52) {
            __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_7); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 35, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
            __Pyx_GOTREF(__pyx_t_9);
          } else {
            #if CYTHON_FAST_PYCALL
            if (PyFunction_Check(__pyx_t_8)) {
              PyObject *__pyx_temp[2] = {__pyx_t_52, __pyx_t_7};
              __pyx_t_9 = __Pyx_PyFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 35, __pyx_L1_error)
            ...
            if (__Pyx_PyFastCFunction_Check(__pyx_t_8)) {
              PyObject *__pyx_temp[2] = {__pyx_t_52, __pyx_t_7};
              __pyx_t_9 = __Pyx_PyCFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 35, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_52); __pyx_t_52 = 0;
              __Pyx_GOTREF(__pyx_t_9);
              __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
            } else
            #endif
            {
              __pyx_t_53 = PyTuple_New(1+1); if (unlikely(!__pyx_t_53)) __PYX_ERR(0, 35, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_53);
              __Pyx_GIVEREF(__pyx_t_52); PyTuple_SET_ITEM(__pyx_t_53, 0, __pyx_t_52); __pyx_t_52 = NULL;
              __Pyx_GIVEREF(__pyx_t_7);
              PyTuple_SET_ITEM(__pyx_t_53, 0+1, __pyx_t_7);
              __pyx_t_7 = 0;
              __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_53, NULL); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 35, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_9);
              __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
            }
          }
          __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
          __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_cmp_img_data, __pyx_v_y, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 35, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_8);
          if (unlikely(__Pyx_SetItemInt(__pyx_t_8, __pyx_v_x, __pyx_t_9, int, 1, __Pyx_PyInt_From_int, 0, 1, 1) < 0)) __PYX_ERR(0, 35, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 */
        /*else*/ {
          ...
          __Pyx_GOTREF(__pyx_t_8);
          __pyx_t_53 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_array); if (unlikely(!__pyx_t_53)) __PYX_ERR(0, 37, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_53);
          __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
          __pyx_t_8 = __Pyx_PyInt_FromDouble((__pyx_v_amt_dif / 1.5)); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 37, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_8);
          ...
          if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_53))) {
            __pyx_t_8 = PyMethod_GET_SELF(__pyx_t_53);
            if (likely(__pyx_t_8)) {
          ...
          if (!__pyx_t_8) {
            __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_53, __pyx_t_7); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 37, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
            __Pyx_GOTREF(__pyx_t_9);
          } else {
            #if CYTHON_FAST_PYCALL
            if (PyFunction_Check(__pyx_t_53)) {
              ...
              __pyx_t_9 = __Pyx_PyFunction_FastCall(__pyx_t_53, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 37, __pyx_L1_error)
            ...
            if (__Pyx_PyFastCFunction_Check(__pyx_t_53)) {
              PyObject *__pyx_temp[2] = {__pyx_t_8, __pyx_t_7};
              __pyx_t_9 = __Pyx_PyCFunction_FastCall(__pyx_t_53, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 37, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
              __Pyx_GOTREF(__pyx_t_9);
              __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
            } else
            #endif
            {
              __pyx_t_52 = PyTuple_New(1+1); if (unlikely(!__pyx_t_52)) __PYX_ERR(0, 37, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_52);
              __Pyx_GIVEREF(__pyx_t_8); PyTuple_SET_ITEM(__pyx_t_52, 0, __pyx_t_8); __pyx_t_8 = NULL;
              __Pyx_GIVEREF(__pyx_t_7);
              PyTuple_SET_ITEM(__pyx_t_52, 0+1, __pyx_t_7);
              __pyx_t_7 = 0;
              __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_53, __pyx_t_52, NULL); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 37, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_9);
              __Pyx_DECREF(__pyx_t_52); __pyx_t_52 = 0;
            }
          }
          __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
          __pyx_t_53 = __Pyx_GetItemInt(__pyx_v_cmp_img_data, __pyx_v_y, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_53)) __PYX_ERR(0, 37, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_53);
          if (unlikely(__Pyx_SetItemInt(__pyx_t_53, __pyx_v_x, __pyx_t_9, int, 1, __Pyx_PyInt_From_int, 0, 1, 1) < 0)) __PYX_ERR(0, 37, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
          __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        }
        __pyx_L11:;
 ...
 */
      /*else*/ {
        __pyx_t_53 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_53)) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_53);
        __pyx_t_52 = __Pyx_PyObject_GetAttrStr(__pyx_t_53, __pyx_n_s_array); if (unlikely(!__pyx_t_52)) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_52);
        __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
        __pyx_t_53 = PyList_New(3); if (unlikely(!__pyx_t_53)) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_53);
        __Pyx_INCREF(__pyx_int_0);
        __Pyx_GIVEREF(__pyx_int_0);
        ...
        __Pyx_INCREF(__pyx_int_0);
        __Pyx_GIVEREF(__pyx_int_0);
        PyList_SET_ITEM(__pyx_t_53, 1, __pyx_int_0);
        __Pyx_INCREF(__pyx_int_0);
        __Pyx_GIVEREF(__pyx_int_0);
        PyList_SET_ITEM(__pyx_t_53, 2, __pyx_int_0);
        __pyx_t_7 = NULL;
        if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_52))) {
          __pyx_t_7 = PyMethod_GET_SELF(__pyx_t_52);
          if (likely(__pyx_t_7)) {
        ...
        if (!__pyx_t_7) {
          __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_52, __pyx_t_53); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 39, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
          __Pyx_GOTREF(__pyx_t_9);
        } else {
          #if CYTHON_FAST_PYCALL
          if (PyFunction_Check(__pyx_t_52)) {
            PyObject *__pyx_temp[2] = {__pyx_t_7, __pyx_t_53};
            __pyx_t_9 = __Pyx_PyFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 39, __pyx_L1_error)
          ...
          if (__Pyx_PyFastCFunction_Check(__pyx_t_52)) {
            PyObject *__pyx_temp[2] = {__pyx_t_7, __pyx_t_53};
            __pyx_t_9 = __Pyx_PyCFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 39, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_7); __pyx_t_7 = 0;
            __Pyx_GOTREF(__pyx_t_9);
            __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
          } else
          #endif
          {
            ...
            PyTuple_SET_ITEM(__pyx_t_8, 0+1, __pyx_t_53);
            __pyx_t_53 = 0;
            __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_52, __pyx_t_8, NULL); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 39, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_9);
            __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
          }
        }
        __Pyx_DECREF(__pyx_t_52); __pyx_t_52 = 0;
        __pyx_t_52 = __Pyx_GetItemInt(__pyx_v_cmp_img_data, __pyx_v_y, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_52)) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_52);
        if (unlikely(__Pyx_SetItemInt(__pyx_t_52, __pyx_v_x, __pyx_t_9, int, 1, __Pyx_PyInt_From_int, 0, 1, 1) < 0)) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_52); __pyx_t_52 = 0;
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      }
      __pyx_L7:;
 ...
 *     print("Image " + str(cnt))
 */
  if (unlikely(__pyx_v_pix_sum == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 40, __pyx_L1_error)
  }
  __pyx_v_avg_err = (__pyx_v_err_sum / __pyx_v_pix_sum);

  /* "cython_verify.pyx":42
 *     avg_err = err_sum / pix_sum
 * 
 *     print("Image " + str(cnt))             # <<<<<<<<<<<<<<
 *     if exact_match:
 ...
 */
  __pyx_t_9 = __Pyx_PyInt_From_int(__pyx_v_cnt); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_52 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_9); if (unlikely(!__pyx_t_52)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_52);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = PyNumber_Add(__pyx_kp_s_Image, __pyx_t_52); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_52); __pyx_t_52 = 0;
  if (__Pyx_PrintOne(0, __pyx_t_9) < 0) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;

  /* "cython_verify.pyx":43
 * 
 *     print("Image " + str(cnt))
 *     if exact_match:             # <<<<<<<<<<<<<<
 *         print("Image is exact match. Zero percent tolerance.")
 ...
 */
  __pyx_t_13 = (__pyx_v_exact_match != 0);
  if (__pyx_t_13) {

    /* "cython_verify.pyx":44
 *     print("Image " + str(cnt))
 *     if exact_match:
 *         print("Image is exact match. Zero percent tolerance.")             # <<<<<<<<<<<<<<
 *     elif (avg_err / 255) < tolerance:
 ...
 */
    if (__Pyx_PrintOne(0, __pyx_kp_s_Image_is_exact_match_Zero_percen) < 0) __PYX_ERR(0, 44, __pyx_L1_error)
 ...
 */
  __pyx_t_13 = (((__pyx_v_avg_err / 255.0) < __pyx_v_tolerance) != 0);
  if (__pyx_t_13) {

    /* "cython_verify.pyx":46
 *         print("Image is exact match. Zero percent tolerance.")
 *     elif (avg_err / 255) < tolerance:
 *         print("Percent tolerance given: {}%".format(tolerance * 100))             # <<<<<<<<<<<<<<
 *         print("Image passed w/ tolerance: {}%".format((avg_err / 255) * 100))
 *     else:
 */
    __pyx_t_52 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_Percent_tolerance_given, __pyx_n_s_format); if (unlikely(!__pyx_t_52)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_52);
    __pyx_t_8 = PyFloat_FromDouble((__pyx_v_tolerance * 100.0)); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_53 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_52))) {
      __pyx_t_53 = PyMethod_GET_SELF(__pyx_t_52);
    ...
    if (!__pyx_t_53) {
      __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_52, __pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 46, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __Pyx_GOTREF(__pyx_t_9);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_52)) {
        PyObject *__pyx_temp[2] = {__pyx_t_53, __pyx_t_8};
        __pyx_t_9 = __Pyx_PyFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 46, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_52)) {
        PyObject *__pyx_temp[2] = {__pyx_t_53, __pyx_t_8};
        __pyx_t_9 = __Pyx_PyCFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 46, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_53); __pyx_t_53 = 0;
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      } else
      #endif
      {
        ...
        __Pyx_GOTREF(__pyx_t_7);
        __Pyx_GIVEREF(__pyx_t_53); PyTuple_SET_ITEM(__pyx_t_7, 0, __pyx_t_53); __pyx_t_53 = NULL;
        __Pyx_GIVEREF(__pyx_t_8);
        PyTuple_SET_ITEM(__pyx_t_7, 0+1, __pyx_t_8);
        __pyx_t_8 = 0;
        __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_52, __pyx_t_7, NULL); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 46, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_52); __pyx_t_52 = 0;
    if (__Pyx_PrintOne(0, __pyx_t_9) < 0) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;

    /* "cython_verify.pyx":47
 *     elif (avg_err / 255) < tolerance:
 *         print("Percent tolerance given: {}%".format(tolerance * 100))
 *         print("Image passed w/ tolerance: {}%".format((avg_err / 255) * 100))             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __pyx_t_52 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_Image_passed_w_tolerance, __pyx_n_s_format); if (unlikely(!__pyx_t_52)) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_52);
    __pyx_t_7 = PyFloat_FromDouble(((__pyx_v_avg_err / 255.0) * 100.0)); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_8 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_52))) {
      __pyx_t_8 = PyMethod_GET_SELF(__pyx_t_52);
      if (likely(__pyx_t_8)) {
        PyObject* function = PyMethod_GET_FUNCTION(__pyx_t_52);
        __Pyx_INCREF(__pyx_t_8);
        __Pyx_INCREF(function);
    ...
    if (!__pyx_t_8) {
      __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_52, __pyx_t_7); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 47, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_GOTREF(__pyx_t_9);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_52)) {
        PyObject *__pyx_temp[2] = {__pyx_t_8, __pyx_t_7};
        __pyx_t_9 = __Pyx_PyFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 47, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_52)) {
        PyObject *__pyx_temp[2] = {__pyx_t_8, __pyx_t_7};
        __pyx_t_9 = __Pyx_PyCFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 47, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      } else
      #endif
      {
        __pyx_t_53 = PyTuple_New(1+1); if (unlikely(!__pyx_t_53)) __PYX_ERR(0, 47, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_53);
        __Pyx_GIVEREF(__pyx_t_8); PyTuple_SET_ITEM(__pyx_t_53, 0, __pyx_t_8); __pyx_t_8 = NULL;
        __Pyx_GIVEREF(__pyx_t_7);
        PyTuple_SET_ITEM(__pyx_t_53, 0+1, __pyx_t_7);
        __pyx_t_7 = 0;
        __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_52, __pyx_t_53, NULL); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 47, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
      }
    }
 ...
 */
  /*else*/ {
    __pyx_t_52 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_Percentage_tolerance_given, __pyx_n_s_format); if (unlikely(!__pyx_t_52)) __PYX_ERR(0, 49, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_52);
    __pyx_t_53 = PyFloat_FromDouble((__pyx_v_tolerance * 100.0)); if (unlikely(!__pyx_t_53)) __PYX_ERR(0, 49, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_53);
    __pyx_t_7 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_52))) {
      __pyx_t_7 = PyMethod_GET_SELF(__pyx_t_52);
    ...
    if (!__pyx_t_7) {
      __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_52, __pyx_t_53); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 49, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
      __Pyx_GOTREF(__pyx_t_9);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_52)) {
        PyObject *__pyx_temp[2] = {__pyx_t_7, __pyx_t_53};
        __pyx_t_9 = __Pyx_PyFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_7); __pyx_t_7 = 0;
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_52)) {
        PyObject *__pyx_temp[2] = {__pyx_t_7, __pyx_t_53};
        __pyx_t_9 = __Pyx_PyCFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_7); __pyx_t_7 = 0;
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_53); __pyx_t_53 = 0;
      } else
      #endif
      {
        ...
        PyTuple_SET_ITEM(__pyx_t_8, 0+1, __pyx_t_53);
        __pyx_t_53 = 0;
        __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_52, __pyx_t_8, NULL); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_52); __pyx_t_52 = 0;
    if (__Pyx_PrintOne(0, __pyx_t_9) < 0) __PYX_ERR(0, 49, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;

    /* "cython_verify.pyx":50
 *     else:
 *         print("Percentage tolerance given: {}%".format(tolerance * 100))
 *         print("Percentage of failure: {}%".format(avg_err / 255 * 100))             # <<<<<<<<<<<<<<
 *     print("----------------------------------------")
 *     return cmp_img_data
 */
    __pyx_t_52 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_Percentage_of_failure, __pyx_n_s_format); if (unlikely(!__pyx_t_52)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_52);
    __pyx_t_8 = PyFloat_FromDouble(((__pyx_v_avg_err / 255.0) * 100.0)); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_53 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_52))) {
      __pyx_t_53 = PyMethod_GET_SELF(__pyx_t_52);
    ...
    if (!__pyx_t_53) {
      __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_52, __pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 50, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __Pyx_GOTREF(__pyx_t_9);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_52)) {
        PyObject *__pyx_temp[2] = {__pyx_t_53, __pyx_t_8};
        __pyx_t_9 = __Pyx_PyFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 50, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_53); __pyx_t_53 = 0;
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_52)) {
        PyObject *__pyx_temp[2] = {__pyx_t_53, __pyx_t_8};
        __pyx_t_9 = __Pyx_PyCFunction_FastCall(__pyx_t_52, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 50, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_53); __pyx_t_53 = 0;
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      } else
      #endif
      {
        ...
        PyTuple_SET_ITEM(__pyx_t_7, 0+1, __pyx_t_8);
        __pyx_t_8 = 0;
        __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_52, __pyx_t_7, NULL); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 50, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_52); __pyx_t_52 = 0;
    if (__Pyx_PrintOne(0, __pyx_t_9) < 0) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  }
  __pyx_L12:;

  /* "cython_verify.pyx":51
 *         print("Percentage tolerance given: {}%".format(tolerance * 100))
 *         print("Percentage of failure: {}%".format(avg_err / 255 * 100))
 *     print("----------------------------------------")             # <<<<<<<<<<<<<<
 *     return cmp_img_data
 */
  ...
  /* "cython_verify.pyx":52
 *         print("Percentage of failure: {}%".format(avg_err / 255 * 100))
 *     print("----------------------------------------")
 *     return cmp_img_data             # <<<<<<<<<<<<<<
 */
  __pyx_t_54 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(__pyx_v_cmp_img_data, PyBUF_WRITABLE); if (unlikely(!__pyx_t_54.memview)) __PYX_ERR(0, 52, __pyx_L1_error)
  __pyx_r = __pyx_t_54;
 ...
 */
  ...
  __Pyx_AddTraceback("cython_verify.verify_image", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_L2:;
  __Pyx_XDECREF(__pyx_v_cmp_img_data);
...
static PyObject *__pyx_pw_13cython_verify_1verify_image(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("verify_image (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_ref,&__pyx_n_s_test,&__pyx_n_s_tolerance,&__pyx_n_s_cnt,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_test)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("verify_image", 1, 4, 4, 1); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_tolerance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("verify_image", 1, 4, 4, 2); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cnt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("verify_image", 1, 4, 4, 3); __PYX_ERR(0, 4, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "verify_image") < 0)) __PYX_ERR(0, 4, __pyx_L3_error)
      }
    ...
    __pyx_v_ref = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ref.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_test = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_test.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_tolerance = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_tolerance == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_cnt = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_cnt == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("verify_image", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_verify.verify_image", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13cython_verify_verify_image(__pyx_self, __pyx_v_ref, __pyx_v_test, __pyx_v_tolerance, __pyx_v_cnt);
...
static PyObject *__pyx_pf_13cython_verify_verify_image(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_ref, __Pyx_memviewslice __pyx_v_test, float __pyx_v_tolerance, int __pyx_v_cnt) {
  ...
  if (unlikely(!__pyx_v_ref.memview)) { __Pyx_RaiseUnboundLocalError("ref"); __PYX_ERR(0, 4, __pyx_L1_error) }
  if (unlikely(!__pyx_v_test.memview)) { __Pyx_RaiseUnboundLocalError("test"); __PYX_ERR(0, 4, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_13cython_verify_verify_image(__pyx_v_ref, __pyx_v_test, __pyx_v_tolerance, __pyx_v_cnt, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 4, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 3, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_verify.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_verify._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"verify_image", (PyCFunction)__pyx_pw_13cython_verify_1verify_image, METH_VARARGS|METH_KEYWORDS, __pyx_doc_13cython_verify_verify_image},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cython_verify(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_verify},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Image_is_exact_match_Zero_percen, __pyx_k_Image_is_exact_match_Zero_percen, sizeof(__pyx_k_Image_is_exact_match_Zero_percen), 0, 0, 1, 0},
  {&__pyx_kp_s_Image_passed_w_tolerance, __pyx_k_Image_passed_w_tolerance, sizeof(__pyx_k_Image_passed_w_tolerance), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_Percent_tolerance_given, __pyx_k_Percent_tolerance_given, sizeof(__pyx_k_Percent_tolerance_given), 0, 0, 1, 0},
  {&__pyx_kp_s_Percentage_of_failure, __pyx_k_Percentage_of_failure, sizeof(__pyx_k_Percentage_of_failure), 0, 0, 1, 0},
  {&__pyx_kp_s_Percentage_tolerance_given, __pyx_k_Percentage_tolerance_given, sizeof(__pyx_k_Percentage_tolerance_given), 0, 0, 1, 0},
 ...
 *     for y in range(h):
 */
  __pyx_tuple_ = PyTuple_Pack(3, __pyx_int_768, __pyx_int_1024, __pyx_int_3); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 22, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcython_verify(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcython_verify(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cython_verify(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cython_verify(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_cython_verify(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cython_verify(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_verify", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cython_verify) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cython_verify")) {
      if (unlikely(PyDict_SetItemString(modules, "cython_verify", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cython_verify", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_verify");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
